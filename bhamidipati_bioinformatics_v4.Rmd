...
#Adding title for the graph and label for y-axis.
  labs(title = "Covid-19 Variants in California", y = "Percentage of sequenced specimens")+
#Scaling the x-axis to show 1 month intervals, and the labels having abbreviated months and unabbreviated year. Also, as per the example given, only including data until May 2022
